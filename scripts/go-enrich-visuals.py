...
OUTPUT_PNG1 = "/N/project/Krolab/isabella/cutandtag-peak-caller-comparison/results/go-enrichment/results/go_enrichment_H3K27ac.png"
OUTPUT_PNG2 = "/N/project/Krolab/isabella/cutandtag-peak-caller-comparison/results/go-enrichment/results/go_enrichment_H3K27me3.png"
#Load data 
...
print(f"Saved to {OUTPUT_PNG1}")


# Create second plot

# Filter to H3K27me3, GO Biological Process only
df_bp = df[
    (df['Histone_Mark'] == 'H3K27me3') &
    (df['Library'] == 'GO_Biological_Process_2023')
].copy()
...
plt.suptitle(
    'Figure 3. GO Biological Process Enrichment: GoPeaks vs MACS2 (H3K27me3)',
    fontsize=11, fontweight='bold', y=1.01
)
plt.tight_layout()
plt.savefig(OUTPUT_PNG2, dpi=200, bbox_inches='tight', facecolor='white')
print(f"Saved to {OUTPUT_PNG2}")
